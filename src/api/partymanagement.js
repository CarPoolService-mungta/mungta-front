...
export const postMoveInfo = async function (Data) {
    ...
    let url =process.env.REACT_APP_API_SERVER + '/api/party-managementpartyInfos/post-moveinfo';
...
export const postMoveInfo2 = async function (Data) {
    const response = await axios.post(process.env.REACT_APP_API_SERVER + '/api/party-managementpartyInfos/post-moveinfo2', stringify(Data));
    return response.data;
}
export const postMoveInfo3 = async (params) =>
        axiosInstance.post('/party-management/partyInfos/post-moveinfo',params);
